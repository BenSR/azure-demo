...
variable "runner_script_sas_url" {
  type        = string
  sensitive   = true
  description = "Read-only SAS URL for the setup-runner.sh blob in the scripts container of the state storage account. Generated by prepare-azure-env.sh and stored as the RUNNER_SCRIPT_SAS_URL GitHub secret."
}
